...
public class FloatingModMenuService extends Service {
  ...
  int MENU_BG_COLOR = Color.parseColor("#FFFF0000"); // #AARRGGBB
  ...
  private void initFloating() {
    ...
    gdMenuBody.setStroke(1, Color.parseColor("#FF32CB00")); // Set border
  ...
  private View COPYBUTTON(final int featNum, final String featName) {
    ...
    gradientDrawable.setStroke(3, Color.parseColor("#FFE64918"));
  ...
  private View Button(final int featNum, final String featName) {
    ...
    gradientDrawable.setStroke(3, Color.parseColor("#FFF7E733")); // рамка
  ...
  private View ButtonLink(final String featName, final String url) {
    ...
    gradientDrawable.setStroke(3, Color.parseColor("#FFF7E733"));
    gradientDrawable.setCornerRadii(new float[] {50, 50, 50, 50, 50, 50, 50, 50});
    button.setBackground(gradientDrawable);
