NepSymbol::LibManager lib; // создаём объект
NepSymbol::Address _Transform, _GetPositionInjected, _WorldToScreenPointIntInjected, _Camera;
...
void getAddress() {
    ...
    // Component
    NepSymbol::Uclass ComponentClass = lib.getClass("UnityEngine", "Component");
    _Transform = ComponentClass.dump("get_transform", 0);

    // Transform
    NepSymbol::Uclass TransformClass = lib.getClass("UnityEngine", "Transform");
    ...
    // Camera
    NepSymbol::Uclass CameraClass = lib.getClass("UnityEngine", "Camera");
